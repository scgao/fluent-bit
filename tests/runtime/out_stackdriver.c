                                             ...
                                             void *data)
{
    ...
    ret = mp_kv_cmp_integer(res_data, res_size, "$entries[0]['httpRequest']['status']", 123);
    TEST_CHECK(ret == FLB_TRUE);
                                              ...
                                              void *data)
{
    ...
    ret = mp_kv_cmp(res_data, res_size, "$entries[0]['httpRequest']['latency']", "315576000000.1000000000s");
    TEST_CHECK(ret == FLB_TRUE);
